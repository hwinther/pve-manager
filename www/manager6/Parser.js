...
Ext.define('PVE.Parser', {
 statics: {
	...
	Ext.Array.each(value.split(','), function(p) {
	    ...
	    if ((match_res = p.match(/^(sunhme|ne2k_pci|e1000|e1000-82540em|e1000-82544gc|e1000-82545em|vmxnet3|rtl8139|pcnet|virtio|ne2k_isa|i82551|i82557b|i82559er)(=([0-9a-f]{2}(:[0-9a-f]{2}){5}))?$/i)) !== null) {
